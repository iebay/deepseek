      ...
      <div className="border-t border-[var(--border-primary)] p-2 shrink-0">
        <div className="flex gap-2 items-end">
          ...
          {isRunning ? (
            <button
              onClick={handleStop}
              className="p-2 rounded-lg bg-[var(--error-bg)] hover:bg-[var(--error-bg)] text-[var(--error)] transition-colors shrink-0"
              title="停止"
            >
              <Square size={15} />
            </button>
            ...
            <button
              ...
              className="p-2 rounded-lg bg-[var(--accent-bg)] hover:bg-[#388bfd]/20 text-[var(--accent-primary)] disabled:opacity-50 transition-colors shrink-0"
              title="发送 (Enter)"
            >
              <Send size={15} />
            </button>
