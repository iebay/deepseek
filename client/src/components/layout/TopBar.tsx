import { Cpu, Home, Eye, PanelLeft, PanelRight, Github, Maximize2, Minimize2, GitBranch, TerminalSquare, CommandIcon, Bot, Search, Undo2, Redo2, Package, BarChart3 } from 'lucide-react';
      ...
      <header className="h-12 bg-[#161b22] border-b border-[#30363d] flex items-center px-3 gap-2 shrink-0">
        ...
        <div className="flex items-center gap-0.5">
          ...
          <button
            ...
            className={`p-1.5 rounded-lg transition-colors ${showNpmPanel ? 'text-[#388bfd] bg-[#388bfd]/10' : 'text-[#8b949e] hover:text-[#e6edf3] hover:bg-[#21262d]'}`}
