    ...
    <div className="flex flex-col h-full bg-[var(--bg-primary)] relative">
      ...
      <div className="px-3 py-2 shrink-0">
        <div className="bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-2xl focus-within:border-[var(--accent-primary)] transition-colors">
          ...
          <textarea
            ref={textareaRef}
            className="w-full bg-transparent text-sm text-[var(--text-primary)] placeholder-[var(--text-tertiary)] px-3 pt-2.5 pb-1 resize-none focus:outline-none min-h-[40px] max-h-[120px]"
            style={{ height: '40px' }}
            placeholder="描述你的需求..."
          ...
          <div className="flex items-center justify-between px-2 pb-2">
            {/* Left: mode buttons + smart mode + image upload */}
            <div className="flex items-center gap-1">
              <button
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-7 h-7 flex items-center justify-center bg-[var(--accent-primary)] hover:bg-[var(--accent-hover)] disabled:bg-[var(--bg-tertiary)] disabled:text-[var(--text-tertiary)] text-white rounded-lg transition-colors"
                title="发送 (Enter)"
              >
                <Send size={13} />
              </button>
