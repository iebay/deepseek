...
export default function SearchPanel() {
  ...
  const btnInactive = `${btnBase} text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)]`;
          ...
          return (
            <div key={result.filePath} className="border-b border-[var(--border-secondary)]">
              ...
              >
                ...
                <span className="text-xs text-[var(--accent-hover)] truncate flex-1 min-w-0">{result.relativePath}</span>
