  ...
  return (
    ...
    >
      ...
      <input
        ...
        onBlur={() => onCancel()}
        className="flex-1 bg-[var(--bg-primary)] border border-[var(--accent-primary)] rounded px-1 py-0.5 text-xs text-[var(--text-primary)] focus:outline-none min-w-0"
      />
    </div>
  );
}
...
function FileTreeNode({
    ...
    return (
      <div>
        {isRenaming ? (
          ...
          <button
            className="flex items-center gap-1 w-full text-left hover:bg-[var(--bg-tertiary)] rounded-md text-sm text-[var(--text-primary)] transition-colors group"
  ...
  return (
    <button
      className={`flex items-center gap-1.5 w-full text-left hover:bg-[var(--bg-tertiary)] rounded-md text-sm transition-colors ${isActive ? 'bg-[var(--bg-tertiary)] text-[var(--text-primary)]' : 'text-[var(--text-secondary)] hover:text-[var(--text-primary)]'}`}
      style={{ paddingLeft: `${8 + depth * 14}px`, paddingRight: '8px', paddingTop: '3px', paddingBottom: '3px' }}
...
export default function FileTree() {
  ...
  if (!fileTree) {
    return (
      <div className="p-4 text-xs text-[var(--text-tertiary)] flex flex-col items-center gap-2 mt-8">
        <Folder size={32} className="text-[var(--border-primary)]" />
        <p>未打开项目</p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      {isDragOver && (
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-[var(--bg-primary)]/80 border-2 border-dashed border-[var(--accent-primary)] rounded-lg pointer-events-none">
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-[var(--bg-tertiary)] border border-[var(--border-primary)] rounded-lg shadow-xl p-5 max-w-sm w-full mx-4">
            ...
            <div className="flex justify-end gap-2">
              <button
                ...
                className="px-3 py-1.5 text-xs rounded-md border border-[var(--border-primary)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)] transition-colors"
              >
                取消
              </button>
              <button
