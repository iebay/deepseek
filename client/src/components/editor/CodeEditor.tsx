  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-2 px-3 py-2 bg-[var(--bg-secondary)] border-b border-[var(--border-primary)] shrink-0">
        ...
        <button onClick={() => setZoom(z => Math.min(400, z + 25))} className="p-1 rounded text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)]" title="放大">
          <ZoomIn size={13} />
        </button>
        <button onClick={() => setZoom(z => Math.max(25, z - 25))} className="p-1 rounded text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)]" title="缩小">
          <ZoomOut size={13} />
        </button>
        <button onClick={() => setRotation(r => (r + 90) % 360)} className="p-1 rounded text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)]" title="旋转">
          <RotateCw size={13} />
        </button>
        <button onClick={() => { setZoom(100); setRotation(0); }} className="text-xs text-[var(--text-tertiary)] hover:text-[var(--text-primary)] px-1.5 py-0.5 rounded hover:bg-[var(--bg-tertiary)]">重置</button>
      </div>
...
function BinaryFileNotice({ path }: { path: string }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-8">
      <FileCode size={40} className="text-[var(--border-primary)] mb-4" />
