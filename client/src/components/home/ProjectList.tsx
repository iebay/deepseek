...
function ProjectCard({ project, onOpen, onToggleFavorite, onRemove }: ProjectCardProps) {
  ...
  return (
    <div
      className="relative group bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-xl p-4 hover:border-[var(--accent-primary)] transition-all duration-200 cursor-pointer"
      ...
      {showMenu && (
        <>
          ...
          <div className="absolute top-8 right-2 z-40 bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-xl shadow-2xl py-1 min-w-[140px]">
            <button
              className="w-full text-left px-3 py-2 text-xs text-[var(--text-primary)] hover:bg-[var(--bg-hover)] flex items-center gap-2 transition-colors"
            ...
            <button
              className="w-full text-left px-3 py-2 text-xs text-[var(--error)] hover:bg-[var(--error)]/10 flex items-center gap-2 transition-colors"
